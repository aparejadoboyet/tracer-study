export const agreement = {
    ...
    heading : 'Privacy Data Statement',

    content : <p>Your privacy is important to us, and we are committed to protecting your personal information. The purpose of this tracer study is to gather information on the outcomes of the Osmena Colleges Computer Science Department's curriculum for the school years 2020 to 2022. Your participation in this study is entirely voluntary, and you have the right to withdraw at any time.<br/><br/>

    All data collected from you will be kept confidential and used solely for research purposes. The data will be stored securely and will only be accessible by authorized personnel involved in this study. Your personal information, such as your name and contact details, will not be disclosed to any third party without your consent.<br/><br/>
